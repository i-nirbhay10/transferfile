...
import { editContactPage_cms, editPagesTerms_cms, getBlog_cms, getTerms_cms, updateBlog_cms, updateUser } from "../../../User_Management/features/userSlice";
...
const CMSTermsandConditions = ({ setActiveTab, setExpand }) => {

  setActiveTab("pages");
  setExpand("contentManagement")
  const head = "Terms and Conditions";
  ...
  const termsData = useSelector((state) => state.userManagement.getTerms_cms);
...
//   }, [blogData])
  ...
  const handleSubmit = async (event) => {
    ...
    setLoading(true);
    await dispatch(editPagesTerms_cms(formData));
    setLoading(false);
    // navigate("/home/blogs")
