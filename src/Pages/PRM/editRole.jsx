...
const EditRole = ({ setExpand, setActiveTab }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("permissions", JSON.stringify(variants)); // Convert variants array to JSON string
    formData.append("role", role);
    formData.append("department", selectdepart);

    setLoading(true);
    await dispatch(editRole({ formData, rid: data.rid })); // Pass the correct rid
    setLoading(false);
  ...
  //   const formData = new FormData();
  //   formData.append("permissions", variants);
  //   formData.append("role", role);
  //   setLoading(true);
